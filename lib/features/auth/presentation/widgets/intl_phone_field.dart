...
class IntlPhoneField2 extends StatefulWidget {
  ...
  const IntlPhoneField2({
    ...
    this.invalidNumberMessage = 'Please check your phone number',
    this.cursorHeight,
  ...
  @override
  State<IntlPhoneField2> createState() => _IntlPhoneField2State();
}
  ...
  Future<void> _changeCountry() async {
    ...
    await showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (ctx, setState) => CountryPickerDialog2(
          languageCode: widget.languageCode.toLowerCase(),
          style: PickerDialogStyle(
              backgroundColor: Colors.white,
              countryCodeStyle: bodyTextStyle.copyWith(fontSize: 14.sp),
              countryNameStyle: bodyTextStyle.copyWith(fontSize: 14.sp)),
                  ...
                  kIsWeb
                      ...
                      : Container(
                          ...
                          decoration: const BoxDecoration(
                              color: Colors
                                  .white, //secondaryColor.withOpacity(0.4),
...
class CountryPickerDialog2 extends StatefulWidget {
  ...
  @override
  _CountryPickerDialog2State createState() => _CountryPickerDialog2State();
}
